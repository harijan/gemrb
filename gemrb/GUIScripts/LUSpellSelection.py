...
def OpenSpellsWindow (actor, table, level, diff, kit=0, gen=0, recommend=True, booktype=0):
	...
	# ... which is also important for mages during chargen and then never again
		...
		print("OpenSpellsWindow: unhandled spell learning type encountered, falling back to memo table:" + str(table))
...
def SpellsCancelPress ():
	...
	if GameCheck.IsBG2():
		...
		print("Uh-oh in SpellsCancelPress in" + str(GemRB.GameType))
	return
